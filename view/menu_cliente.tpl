...
<section class="row">
    ...
    <div class="text-center">
        ...
        <a href="{$PAG_CLIENTES_PEDIDOS}" class="btn btn-success"><i class="glyphicon glyphicon-barcode"></i> Pedidos</a>
        <a href="{$PAG_CLIENTES_DADOS}" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i> Meus Dados </a>
        <a href="{$PAG_CARRINHO}" class="btn btn-success"><i class="glyphicon glyphicon-shopping-cart"></i> Carrinho </a>
        <a href="{$PAG_CLIENTES_SENHA}" class="btn btn-warning"> Alterar Senha </a>
