...
<form name="cadcliente" id="cadcliente" method="post" action="">
    ...
    <section class="row" id="cadastro">
        ...
        <div class="col-md-2">
            <label>CPF:</label>
            <input type="text" value="{$CLI_CPF}" name="cli_cpf" class="form-control" minlength="11" maxlength="11"  readonly>
        </div>
    ...
    <section class="row" id="btngravar">
        ...
        <div class="col-md-4">
            <input type="hidden" value="{$CLI_ID}" name="cli_id"  id="cli_id" class="form-control" >
            <br>
