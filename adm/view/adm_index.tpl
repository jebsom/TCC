            ...
            <div class="row" id="topo">
                <div class="container">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        {if $LOGADO == true}
                            Olá: {$USER} 
                            <a href="{$PAG_ADM_SENHA}" class="btn btn-warning"><i class="glyphicon glyphicon-asterisk"></i>Alterar Senha</a> 
                            <a href="{$PAG_LOGOFF}" class="btn btn-danger"><i class="glyphicon glyphicon-log-out"></i> Sair </a><br> <br>
                            <h6><p>Último logn em: {$DATA} as {$HORA}</p></h6>
                        {/if}
                    </div>
                </div>    
            </div>
                ...
                <div class="container"> 
                    ...
                    <section class="row">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{$PAG_CATEGORIAS_ADM}" class="btn btn-success"><i class="glyphicon glyphicon-home"></i> Categorias</a>
                            <a href="{$PAG_PRODUTOS_ADM}" class="btn btn-success"><i class="glyphicon glyphicon-barcode"></i> Produtos</a>
                            <a href="{$PAG_CLIENTES_ADM}" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i> Clientes</a>
                            <a href="{$PAG_PEDIDOS_ADM}" class="btn btn-success"><i class="glyphicon glyphicon-shopping-cart"></i> Pedidos</a>
                            <a href="{$PAG_ADM_SENHA}" class="btn btn-warning"> Alterar Senha </a>
